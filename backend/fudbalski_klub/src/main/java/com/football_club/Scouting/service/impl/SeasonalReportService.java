...
public class SeasonalReportService implements ISeasonalReportService {
    ...
    private SeasonalReportDTO mapToDTO(SeasonalReport report) {
        ...
        return SeasonalReportDTO.builder()
                ...
                .leagueId(report.getLeague().getId())
                .leagueName(report.getLeague().getName())
                .difficultyMultiplier(report.getLeague().getDifficultyMultiplier())
                .seasonYear(report.getSeasonYear())
                .minutesPlayed(report.getMinutesPlayed())
                .goalsPer90(report.getGoalsPer90())
                .assistsPer90(report.getAssistsPer90())
                .avgWeightedRating(report.getAvgWeightedRating())
